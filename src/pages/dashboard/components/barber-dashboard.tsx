...
const BarberDashboard = () => {
  ...
  } = useGetCurrentUserAppointments(Boolean(user && isWorker));

  const {
    data: recommendations,
    isLoading: loadingRecommendations,
    error: errorRecommendations,
  } = useGetCurrentUserRecommendations(Boolean(user && isWorker));

  if (loadingAppointments || loadingRecommendations) {
  ...
  return (
    <div className="p-6 md:grid grid-cols-12 gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-8 gap-6 mb-4">
          <Card className="col-span-4">
            <CardContent className="flex flex-col justify-between h-full">
              <h2 className="text-2xl font-semibold mb-2">Hoje</h2>
              <h3 className="text-6xl font-semibold">{appointments.length}</h3>
            </CardContent>
          </Card>
      ...
      <div className="col-span-3">
        ...
        <Card>
          <CardContent>
            <h2 className="font-semibold text-3xl mb-6">Clientes favoritos</h2>
            {[].length === 0 ? (
              <div className="flex flex-col items-center justify-center py-12 px-4">
                <div className="relative mb-6">
                  ...
                  <li key={recommendation.id}>
                    <div className="flex justify-between items-center p-2 rounded-lg">
                      <div className="flex items-center gap-3">
                        <AvatarIcon
                          name={recommendation.customerName}
                          photoURL={recommendation.customerPhotoUrl}
                          size="extra-small"
                        />
                        <div>
                      ...
                      <button className="p-2 rounded-full hover:bg-brand-secondary/10 transition-all duration-200">
